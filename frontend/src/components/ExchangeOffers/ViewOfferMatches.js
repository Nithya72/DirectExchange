...
export class ViewOfferMatches extends Component {
  ...
  postSplitCounterHandler = (e, offer1, offer2, offer) => {
    ...
    if( this.state.split_count_offer_amount - (offer1.finalAmount + offer2.finalAmount) > 0 ){
      console.log("first of all true");
      isAdd = true;
    }
    ...
    if (offer1.remitAmount >= offer2.remitAmount) {
      ...
      if(isAdd) {
        counter_amount = offer1.finalAmount + (this.state.split_count_offer_amount - (offer1.finalAmount + offer2.finalAmount))
      }
      else{
        counter_amount = offer1.finalAmount - ((offer1.finalAmount + offer2.finalAmount) - this.state.split_count_offer_amount)
      }
      ...
      if(isAdd) {
        console.log("isAdd here");
        counter_amount = offer2.finalAmount + (this.state.split_count_offer_amount - (offer1.finalAmount + offer2.finalAmount))
      }
      else{
        counter_amount = offer2.finalAmount - ((offer1.finalAmount + offer2.finalAmount) - this.state.split_count_offer_amount)
      }
                                    ...
                                    <div className="buy-sell-widget">
                                      <ul className="nav nav-tabs">
                                        ...
                                        {(parseInt(offer.remitAmount) - parseInt(this.state.offer.finalAmount) == 0) ?
                                            ...
                                            <button className="counter-offer-button"
                                                    data-toggle="modal"
                                                    data-target={"#acceptOfferModalPopup"+ offer.offerId}
                                        ...
                                        {(offer.counterOfferFlag.toString() === "true" ?
                                            <div>
                                              <button className="counter-offer-button"
                                                      ...
                                                      data-target= {"#newOfferModalPopup" + offer.offerId}
                                              >
                                                Counter
                                              </button>
                                              ...
                                              <div
                                                  ...
                                                  id = {"acceptOfferModalPopup"+ offer.offerId}
                                                  role="dialog"
                                                    ...
                                                    <div className="modal-body"
                                                      ...
                                                      <div
                                                        ...
                                                        <div
                                                          ...
                                                          <br/>
                                                          <div>Please note: There is a difference between your initial
                                                            offer and the amount to be sent.
                                                            <br/>
                                                            <br/>
                                                            <div> Accept below to match the offer or Post a counter
                                                              offer
                                                            </div>
                                                          ...
                                                          {this.state.postCounterOfferFlag ? <div
                                                                  style={{color: "green"}}>{this.state.postCounterMsg}</div> :
                                                              <div
                                                                  style={{color: "red"}}>{this.state.postCounterMsg}</div>}
                                                        </div>
                                              ...
                                              <div
                                                  ...
                                                  id = {"newOfferModalPopup"+offer.offerId}
                                                  role="dialog"
                                                  aria-labelledby="exampleModalCenterTitle"
                                                  aria-hidden="true"
                                              >
                                        ...
                                        <div className="buy-sell-widget">
                                          <ul className="nav nav-tabs">
                                            ...
                                            {((parseInt(offer[0].remitAmount + offer[1].remitAmount) - parseInt(this.state.offer.finalAmount)) == 0) ?
                                                ...
                                                <button className="counter-offer-button"
                                                        data-toggle="modal"
                                                        data-target={ "#acceptSplitOfferModalPopup" + offer[0].offerId +"--"+ offer[1].offerId}
                                                    // onClick={(e) => this.acceptSingleOfferHandler(e, offer, "accept")}
                                            ...
                                            <div
                                                ...
                                                id={"acceptSplitOfferModalPopup" + offer[0].offerId +"--"+ offer[1].offerId}
                                                role="dialog"
                                                aria-labelledby="exampleModalCenterTitle"
                                                aria-hidden="true"
                                             >
                                            ...
                                            {(offer[0].counterOfferFlag.toString() === "true" || offer[1].counterOfferFlag.toString() === "true") ?
                                                <div>
                                                  <button className="counter-offer-button"
                                                          data-toggle="modal"
                                                          data-target={ "#newSplitOfferModalPopup" + offer[0].offerId +"--"+ offer[1].offerId}>
                                                    Counter
                                                  </button>
                                                  <div
                                                      className="modal fade"
                                                      id={"newSplitOfferModalPopup" + offer[0].offerId +"--"+ offer[1].offerId}
                                                      role="dialog"
                                                      aria-labelledby="exampleModalCenterTitle"
                                                      aria-hidden="true"
                                                  >
                                                        ...
                                                        <div className="modal-body"
                                                          ...
                                                          <div
                                                            ...
                                                            <div
                                                              ...
                                                              <br/>
                                                              <div>Note: The counter offer must be within the range of
                                                                90%
                                                                to 110% of source remit amount
                                                              </div>
                                                              <br/>
                                                              ...
                                                              <button
                                                                  type="submit"
                                                                  className="post-counter-offer-custom-button"
                                                                  onClick={(e) => this.postSplitCounterHandler(e, offer[0], offer[1], offer)}>
                                                                POST COUNTER
                                                                OFFER
                                                              </button>
                                                              <br/> <br/> <br/>
